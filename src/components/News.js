...
const News = (props) => {
  ...
  useEffect(() => {
    document.title = `${capitalizeFirstLetter(props.category)} - SnapRead`
    updateNews();
  ...
  return (
    <> 
      <h1 className='text-center' style={{margin: '90px 0px 30px'}}>SnapRead - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
      {loading && <Spinner />}
